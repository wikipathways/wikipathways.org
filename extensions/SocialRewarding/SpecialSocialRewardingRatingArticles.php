...
/**
 * Special page for displaying list of rated articles.
 */
class SpecialSocialRewardingRatingArticles extends PageQueryPage {
	 ...
	 */
	function getName() {
		return "SocialRewardingRatingArticles";
	}
	...
	function getSQL() {
		...
		$sql  = "SELECT
				'Social Rewarding: Rating of Articles' AS type,
				page_namespace AS namespace,
				page_title AS title,
				ROUND((SUM(points) / SUM(count)), " . $SocialRewarding["reward"]["round"] . ") AS value,
				page_len AS length,
				page_id
			FROM
 ...
 * @access public
 */
function wfSpecialSocialRewardingRatingArticles() {
	list($limit,$offset) = wfCheckLimits();
	$site = new SpecialSocialRewardingRatingArticles();
